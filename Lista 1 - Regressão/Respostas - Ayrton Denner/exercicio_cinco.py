...
def calcula_novo_item(novo_x, lista_coeficientes):
    ...
    calculo = lista_coeficientes.item(0, 0) + novo_x[0] * lista_coeficientes.item(1, 0) + novo_x[1] * lista_coeficientes.item(2, 0) + novo_x[2] * lista_coeficientes.item(3, 0) + novo_x[3] * lista_coeficientes.item(4, 0) + novo_x[4] * lista_coeficientes.item(5, 0)
...
# Qual deve ser o preço de um imóvel com 100m2, 3 anos, andar de número 5, 3 quartos e 2 vagas de garagem?
novo_item = np.array([100, 3, 5, 3, 2])
