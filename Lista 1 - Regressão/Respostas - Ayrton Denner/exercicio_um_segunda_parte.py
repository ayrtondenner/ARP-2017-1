...
# Dessa vez, nós calculamos as equações com apenas os 10 primeiros, porém os cálculos da reta e outras propriedades serão com todos os elementos

reta_calculada = calcula_reta(array_idade, lista_coeficientes["b0"], lista_coeficientes["b1"])

plt.scatter(array_idade, array_probabilidade)
plt.plot(array_idade, reta_calculada, "-")

erro_quadratico_medio = calcula_erro_quadratico_medio(array_probabilidade, reta_calculada)
coeficiente_determinacao = calcula_coeficiente_determinacao(array_idade, array_probabilidade)
